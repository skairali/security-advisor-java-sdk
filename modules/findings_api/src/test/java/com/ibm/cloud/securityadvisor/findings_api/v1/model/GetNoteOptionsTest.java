...
/**
 * Unit test class for the GetNoteOptions model.
 */
public class GetNoteOptionsTest {
  ...
  public void testGetNoteOptionsError() throws Throwable {
    new GetNoteOptions.Builder().build();
  }
