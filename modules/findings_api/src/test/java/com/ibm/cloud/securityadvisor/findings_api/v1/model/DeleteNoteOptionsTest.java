...
/**
 * Unit test class for the DeleteNoteOptions model.
 */
public class DeleteNoteOptionsTest {
  ...
  public void testDeleteNoteOptionsError() throws Throwable {
    new DeleteNoteOptions.Builder().build();
  }
