 ...
 */
public class GetChannelResponseChannel extends GenericModel {
   ...
   * @return the severity
   */
  public GetChannelResponseChannelSeverity getSeverity() {
    return severity;
  }
   ...
   */
  public List<GetChannelResponseChannelAlertSourceItem> getAlertSource() {
    return alertSource;
  }
